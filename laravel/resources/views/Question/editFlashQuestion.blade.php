      ...
      <div class="col-md-12">
        ...
        <div class="box">
            <div class="box-header with-border">
              <h1 class="box-title">Question's Detail Flash Card </h1>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  <th>Definition</th>
                  <th><input id="definition" type="text" class="form-control" name="definition"  value=" {{$Question->Definition}}" >
...
<script type="text/javascript">
  ...
  function validateQuestion(evt,abc){
    ...
    if(chapterChoose == null){
     ...
     var Defi =  $.trim($('#definition').val());
             if(Defi.length==0){
              swal ( "Oops" ,  "Please input definition" ,  "error" );
